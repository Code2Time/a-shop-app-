...
function Exclusivity() {
  return (
    <div className="grid grid-cols-12 my-32  h-auto gap-5  sm:gap-10">
      <div className=" ExclusivityItem-container col-span-12 sm:col-span-6 md:col-span-3 text-center   flex items-center justify-center gap-4 p-1 cursor-pointer">
        ...
        <div className="Exclusivity-info flex flex-col items-center justify-center border-blue-900 dark:border-my-white border-l-2 px-4">
          ...
          <p className="text-black dark:text-blue-four poppins">We ensure the product quality that is our main goal</p>
        </div>
      </div>
      <div className=" ExclusivityItem-container col-span-12 sm:col-span-6 md:col-span-3 text-center   flex items-center justify-center gap-4 p-1 cursor-pointer">
        <div className="Exclusivity-img">
      ...
      <div className=" ExclusivityItem-container col-span-12 sm:col-span-6 md:col-span-3 text-center   flex items-center justify-center gap-4 p-1 cursor-pointer">
        ...
        <div className="Exclusivity-info flex flex-col items-center justify-center border-blue-900 dark:border-my-white border-l-2 px-4">
          ...
          <p className="text-black dark:text-blue-four poppins">Provide free home delivery for the all product over $100.</p>
        </div>
      </div>
      <div className=" ExclusivityItem-container col-span-12 sm:col-span-6 md:col-span-3 text-center   flex items-center justify-center gap-4 p-1 cursor-pointer">
        <div className="Exclusivity-img">
        ...
        <div className="Exclusivity-info flex flex-col items-center justify-center border-blue-900 dark:border-my-white border-l-2 px-4">
          ...
          <p className="text-black dark:text-blue-four poppins">Lorem ipsum dolor sit amet, consectetur adipisicing elit..</p>
        </div>
      </div>
    </div>
  );
