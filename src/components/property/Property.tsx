...
function Property() {
  return (
    <div className="property-section my-36 sm:mt-28 smd:mt-32">
      <div className="property-container grid grid-cols-12 h-auto w-full gap-3 ">
        <div className="property-item col-span-12 sm:col-span-6 smd:col-span-3  flex flex-col p-12 gap-5 cursor-pointer shadow-sm shadow-blue-four dark:shadow-blue-three transition-all hover:-translate-y-1 rounded-sm">
        ...
        <CountUp
            ...
            duration={2}
          />
          <span className="text-black dark:text-blue-three text-3xl sm:text-4xl">+</span>
        </div>
