    ...
    <div data-aos="fade-up" data-aos-duration="900">
      ...
      <Container>
        ...
        <div className="mt-20 h-autow-full  grid grid-cols-12 gap-5  ">
          <h1 className="dark:text-blue-two text-blue-four col-span-12 brand-text flex items-center justify-start border-l-4 border-blue-500 p-2 dark:border-l-0  my-2 ">
            <img
