...
function Home() {
  ...
  return (
    ...
    <div className="mt-20 h-autow-full  grid grid-cols-12 gap-5  ">
      <h1 className="dark:text-blue-two text-blue-four col-span-12 brand-text flex items-center justify-start border-l-4 border-blue-500 p-2 dark:border-l-0 "><img className='h-auto w-5  sm:w-12 hidden dark:block opacity-70' src="https://codenight.ir/_next/image?url=%2Fassets%2Fimages%2FtitleCircleRed.png&w=128&q=75" alt="" /><span className='head sm:text-xl'>Top brands</span></h1>
      <Thirdslideshow />
    </div>
    </Container>
