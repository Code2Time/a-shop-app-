        ...
        <div className="w-full h-screen">
          ...
          <div className="">
            <div className=" mt-44 sm:mt-64 m-auto flex flex-col justify-center items-center z-10">
              <img
                className="size-44 sm:size-52 cursor-pointer hover:scale-105 transition-all"
                src={emptycart}
                alt=""
              />
              <Link
              ...
              >
                ...
                <span className="dark:text-blue-three poppins text-blck text-xs  sm:text-base md:text-lg">
                  {" "}
                  your cart is empty click here for buy
                </span>
              </Link>
            </div>
          </div>
            ...
            <div className="cart grid grid-cols-12 gap-2  w-10/12 max-w-[1500px] mx-auto  p-5 mt-24">
              <div className="card-types-container col-span-12  md:col-span-5   h-auto order-2 rounded-sm flex flex-col justify-center items-center gap-5 p-2">
                <div className=" flex flex-row justify-around items-center h-9 w-full">
                  <h1 className="dark:text-my-white poppins text-blue-four  ">
                    Cart Details
                  </h1>
                  <img
                    className="size-12 md:size-16 cursor-pointer transition-all hover:scale-105"
                    src={logo}
                    alt="logo"
                  />
                </div>
                <div className="card-type flex flex-col justify-start w-full gap-5">
                  <h2 className="uppercase dark:text-blue-three poppins text-blue-four sm:text-xl">
                    card types
                  </h2>
                  ...
                  <div className="flex flex-col gap-5">
                    <input
                      required
                      type="text"
                      className="hover:bg-slate-500 rounded-md w-[85%] mx-auto  focus:outline-none placeholder:text-black placeholder:text-sm poppins bg-slate-400 focus:bg-slate-500 text-left py-1 px-2   hover:cursor-pointer"
                      placeholder="CardHoldersName"
                    />
                    <input
                      required
                      type="text"
                  ...
                  <div className="flex w-full items-center">
                    <input
                      required
                      type="text"
                      className="hover:bg-slate-500 rounded-md w-[40%] mx-auto  focus:outline-none placeholder:text-black placeholder:text-sm poppins bg-slate-400 focus:bg-slate-500 text-left py-1 px-2   hover:cursor-pointer"
                      placeholder="Expirition"
                    />
                    <input
                      required
                      type="number"
                      className="hover:bg-slate-500 rounded-md w-[30%] mx-auto  focus:outline-none placeholder:text-black placeholder:text-sm poppins bg-slate-400 focus:bg-slate-500 text-left py-1 px-2   hover:cursor-pointer"
                      placeholder="Cvv"
                    />
                  </div>
              ...
              <div className="cart-items-container col-span-12  md:col-span-7  h-auto rounded-sm p-8  flex flex-col overflow-hidden">
                <Link
                  to="/store"
                  className=" flex flex-row-reverse justify-end items-center gap-2 dark:text-my-white head text-black text-xs sm:text-xl my-5 line-clamp-1"
                >
                ...
                <div className=" flex justify-around items-center my-5">
                  <h1 className=" dark:text-blue-three poppins text-blck text-xs  sm:text-base md:text-lg line-clamp-1">
                    Shopping Cart
                  </h1>
                  <h5 className=" dark:text-blue-three poppins text-blck text-xs  sm:text-base md:text-lg  line-clamp-1">
